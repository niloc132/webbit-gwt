...
//					DomGlobal.console.log("An error occurred while handling a message from the server, and no client or connection handler was found - pass a error handler to your server builder to handle this yourself", ex);
//				}
//			}
//			return null;
//		};
//
//		Js.<JsPropertyMap<OnopenFn>>cast(connection).set("onerror", e -> {
//			if (errorHandler != null) {
...
//	 * by the server
//	 */
//	private void __onMessage(String message) throws com.google.gwt.user.client.rpc.SerializationException {
//		__checkClient();
//		assert message.startsWith("//OK");//consider axing this, and the substring below
//		StringSerializationStreamReader clientSerializationStreamReader = new StringSerializationStreamReader(__getSerializer(), message.substring(4));
//
...
//
//		AbstractSerializationStreamWriter writer = new StringSerializationStreamWriter(__getSerializer(), "", "101010");
...
//				errorHandler.onError(e);
//			} else {
//				DomGlobal.console.log("A serialization error occurred - pass a error handler to your server builder to handle this yourself", e);
//			}
//
...
//	 * @param params
//	 */
//	protected void __sendMessage(String methodName, Callback<?, ?> callback, Object... params) throws com.google.gwt.user.client.rpc.SerializationException {
...
//		if (getClient() == null) {
//			DomGlobal.console.log("Client has not been assigned for " + getClass() + ": make sure to call setClient to receive server messages.");
//		}
//		return getClient();
//	}
//
